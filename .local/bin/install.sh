...
install_golang() {
	...
	go get github.com/gr8monk3ys/gmailfilters
	go get github.com/gr8monk3ys/junk/sembump
	go get github.com/gr8monk3ys/secping
	go get github.com/gr8monk3ys/ship
	go get github.com/gr8monk3ys/tdash
	...
	for project in "${aliases[@]}"; do
		...
		if [[ "$owner" != "gr8monk3ys" ]] && [[ "$owner" != "genuinetools" ]]; then
			(
			cd "${GOPATH}/src/github.com/${project}"
			git remote set-url --push origin no_push
			git remote add gr8monk3ys "https://github.com/gr8monk3ys/${repo}.git"
			)
		fi
	done
	...
	for krepo in "${kubes_repos[@]}"; do
		...
		git remote set-url --push origin no_push
		git remote add gr8monk3ys "https://github.com/gr8monk3ys/${krepo}.git"
	done
	)
...
get_dotfiles() {
	...
	if [[ ! -d "${HOME}/dotfiles" ]]; then
		...
		git clone git@github.com:gr8monk3ys/dotfiles.git "${HOME}/dotfiles"
	fi

	cd "${HOME}/dotfiles"

	# set the correct origin
	git remote set-url origin git@github.com:gr8monk3ys/dotfiles.git
...
install_vim() {
	...
	# - For Debian distributions: Lorenzo, sid, etc...
	...
	# install .vim files
	sudo rm -rf "${HOME}/.vim"
	git clone --recursive git@github.com:gr8monk3ys/.vim.git "${HOME}/.vim"
	(
	cd "${HOME}/.vim"
	make install
	)
