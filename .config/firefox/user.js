...
/*** [SECTION 9999]: DOTFILES OVERRIDES
   Everything above this line is arkenfox, unmodified. Keep it that way:
   updating arkenfox means replacing everything above and re-appending this
   block, which is why the block is last and clearly fenced.

   arkenfox applies prefs in order, so a later user_pref wins. That is the
   whole mechanism here — no tooling required.
***/
user_pref("_user.js.parrot", "9999 syntax error: the parrot's pushing up daisies!");

/* 9999.1: keep cookies and site storage across restarts.
 * arkenfox 2811 sets this true, which logs you out of every site every time
