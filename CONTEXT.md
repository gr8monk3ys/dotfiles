...
a failure is fatal, for every verb — one axis, one spelling, replacing the
per-tool booleans and flags that could not express "skip cask-extra but not
cask". Boolean knobs share one truthiness rule, `knob_on` in
